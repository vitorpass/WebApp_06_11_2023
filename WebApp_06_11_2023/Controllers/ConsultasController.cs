...
namespace WebApp_06_11_2023.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdConsulta,IdPaciente,dataConsulta,fichaConsulta")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdConsulta,IdPaciente,dataConsulta,fichaConsulta")] Consulta consulta)
        {
